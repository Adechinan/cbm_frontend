...
export default function RecensementForm({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      router.push('/batiments/recensements')
    } catch (err) {
    ...
    <>
      ...
      <Card className="mb-3">
        <CardHeader className="d-flex align-items-center justify-content-between">
          ...
          <Link href="/batiments/recensements" className="d-flex align-items-center gap-1 small">
            {/* <i className="tabler-arrow-left" /> ArrowBackUp */}
        ...
        <CardBody className="p-0">
          <Tab.Container activeKey={activeTab} onSelect={(k) => setActiveTab(k ?? 'fonctionnel')}>
            <Nav variant="tabs" className="px-3 pt-3">
              <Nav.Item>
                <Nav.Link eventKey="fonctionnel">État Fonctionnel</Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="technique">État Technique</Nav.Link>
              </Nav.Item>
            </Nav>
