...
import ApiAccordion from './technique/components/ApiAccordion'
...
export default function DocumentationPage() {
  return (
    <div>
      <PageTitle title="Documentation" subTitle="Accueil" />

      {/* Intro */}
      <div className="p-4 rounded-3 mb-4 bg-primary bg-opacity-10 border border-primary border-opacity-25">
