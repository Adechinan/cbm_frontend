        ...
        <Row className="g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
          <Col xl={4} lg={5} md={6}>
            <Card className="overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
              ...
              <Image src={comingSoon} alt="Coming Soon Img" className="mb-2 w-auto" width={491} height={200} />
              <Timer />
              ...
              <div className="d-flex justify-content-center gap-2">
                <Button variant='danger' className="d-inline-flex align-items-center justify-content-center rounded avatar-md "><span> <IconifyIcon icon='tabler:brand-google-filled' className="fs-20" /></span></Button>
                <Button variant='primary' className="d-inline-flex align-items-center justify-content-center rounded avatar-md "><span> <IconifyIcon icon='tabler:brand-facebook' className=" fs-20" /></span></Button>
                <Button variant='info' className="d-inline-flex align-items-center justify-content-center rounded avatar-md "><span> <IconifyIcon icon='tabler:brand-linkedin' className=" fs-20" /></span></Button>
                <Button variant='warning' className="d-inline-flex align-items-center justify-content-center rounded avatar-md "><span> <IconifyIcon icon='tabler:brand-github' className=" fs-20" /></span></Button>
