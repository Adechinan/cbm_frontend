...
const PagesDropdown = () => {
  ...
  return (
    <div className="topbar-item d-none d-md-flex">
      <Dropdown>
        <DropdownToggle as={'a'} className="topbar-link btn btn-link px-2 dropdown-toggle drop-arrow-none fw-medium"
                ...
                <ul className="list-unstyled megamenu-list">
                  {
                    uiComponentPageData.map((item, idx) => {
                      return (
                        <li key={idx} className='d-flex arrow-none icons-center'>
            ...
            <Col md={4} className="bg-light bg-opacity-50">
              <div className="p-3">
                ...
                <ul className="list-unstyled megamenu-list" >
                  ...
                  <li className='d-flex arrow-none icons-center'>
                    <IconifyIcon icon='tabler:chevron-right' />
